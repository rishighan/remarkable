 ...
 * Footnotes
 */
// changes to reflect the recommended markup for littlefoot/barefoot/bigfoot
// https://github.com/goblindegook/littlefoot#usage
rules.footnote_ref = function(tokens, idx) {
  ...
  return '<sup id="fnref:"' + n+ '><a href="#fn:' + n + '" rel="footnote">' + n + '</a></sup>';
};
rules.footnote_block_open = function(tokens, idx, options) {
  var hr = options.xhtmlOut
    ? '<hr class="footnotes-sep" />\n'
    : '<hr class="footnotes-sep">\n';
  return hr + '<div class="footnotes">\n<ol>\n';
};
...
rules.footnote_open = function(tokens, idx) {
  ...
  return '<li id="fn:' + id + '" class="footnote">';
};
